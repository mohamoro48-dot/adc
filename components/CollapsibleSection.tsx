...
const CollapsibleSection: React.FC<CollapsibleSectionProps> = ({ id, title, icon, borderColorClass, isOpenDefault = false, children }) => {
    ...
    return (
        <section id={id} className={`bg-white shadow-2xl rounded-xl border-t-8 ${borderColorClass} overflow-hidden transition-all duration-700 ease-out transform opacity-0 translate-y-5`}>
            <button
